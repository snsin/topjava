...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal m SET m.description=:description, m.dateTime=:dateTime," +
...
public class Meal extends BaseEntity {
    ...
    public static final String BETWEEN = "Meal.getBetweenSorted";
